...
class Project(models.Model):
    ...
    thumbnail = ResizedImageField(size=[650, 600],scale=0.5, quality=100, crop=['middle', 'center'], null=False, blank=True, force_format='PNG',upload_to=os.path.join(BASE_DIR,'news'))
